...
def home():
    ...
    def new_note():
        ...
        output_label.place(x=230,y=8)
        new_win.mainloop()
    sidebar_button_1 = customtkinter.CTkButton(sidebar_frame, text="Add New Note",command=new_note)
    sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)
    def voice_note():
         pass
    sidebar_button_2 = customtkinter.CTkButton(sidebar_frame, text="Add Voice Note",command=voice_note)
